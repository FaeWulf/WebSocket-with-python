# This function file will make a .html file with automatic check every files in folder dat and make a download 
# list from it.

# Sorry if the file is too long :) Because I am suck at html and CSS
